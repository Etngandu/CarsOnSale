...
namespace ENB.Car.Sales.EF.Repositories
{
    ...
    /// </summary>
    public class AsyncCarForSaleRepository : AsyncRepository<CarForSale>, IAsyncCarForSaleRepository
    {
        /// <summary>
        ...
        public AsyncCarForSaleRepository(CarSalesContext carSalesContext) : base(carSalesContext)
        {
            _carSalesContext = carSalesContext;
        }
        public IEnumerable< CarForSale> FindByName(string lastname)
        {
            return _carSalesContext.Set<CarForSale>().Where(x => x.Current_Mileage == lastname);
        }
    }
}
