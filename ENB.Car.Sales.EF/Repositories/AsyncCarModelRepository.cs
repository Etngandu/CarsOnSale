...
namespace ENB.Car.Sales.EF.Repositories
{
    ...
    /// </summary>
    public class AsyncCarModelRepository : AsyncRepository<CarModel>, IAsyncCarModelRepository
    {
        /// <summary>
        ...
        public AsyncCarModelRepository(CarSalesContext carSalesContext) : base(carSalesContext)
        {
            _carSalesContext = carSalesContext;
        }
        public IEnumerable<CarModel> FindByName(string lastname)
        {
            return _carSalesContext.Set<CarModel>().Where(x => x.Model_Name == lastname);
        }
    }
}
