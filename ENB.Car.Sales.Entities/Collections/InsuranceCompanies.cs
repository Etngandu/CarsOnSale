...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class InsuranceCompanies : CollectionBase<InsuranceCompany>
  {
        /// <summary>
        ...
        public InsuranceCompanies(IList<InsuranceCompany> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public InsuranceCompanies(CollectionBase<InsuranceCompany> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var insuranceCompany in this)
      {
        errors.AddRange(insuranceCompany.Validate());
      }
      return errors;
    }
  }
