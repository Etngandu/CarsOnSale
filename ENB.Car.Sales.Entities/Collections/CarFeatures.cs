...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class CarFeatures : CollectionBase<CarFeature>
  {
        /// <summary>
        ...
        public CarFeatures(IList<CarFeature> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public CarFeatures(CollectionBase<CarFeature> initialList) : base(initialList) { }
