...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class CarSolds : CollectionBase<CarSold>
  {
        /// <summary>
        ...
        public CarSolds(IList<CarSold> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public CarSolds(CollectionBase<CarSold> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var carSold in this)
      {
        errors.AddRange(carSold.Validate());
      }
      return errors;
    }
  }
