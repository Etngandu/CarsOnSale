...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class FinanceCompanies : CollectionBase<FinanceCompany>
  {
        /// <summary>
        ...
        public FinanceCompanies(IList<FinanceCompany> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public FinanceCompanies(CollectionBase<FinanceCompany> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var financeCompany in this)
      {
        errors.AddRange(financeCompany.Validate());
      }
      return errors;
    }
  }
