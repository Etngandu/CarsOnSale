...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class CustomerPayments : CollectionBase<CustomerPayment>
  {
        /// <summary>
        ...
        public CustomerPayments(IList<CustomerPayment> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public CustomerPayments(CollectionBase<CustomerPayment> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var carFeature in this)
      {
        errors.AddRange(carFeature.Validate());
      }
      return errors;
    }
  }
