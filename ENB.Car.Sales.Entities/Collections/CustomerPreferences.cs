...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class CustomerPreferences : CollectionBase<CustomerPreference>
  {
        /// <summary>
        ...
        public CustomerPreferences(IList<CustomerPreference> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public CustomerPreferences(CollectionBase<CustomerPreference> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var customerPreference in this)
      {
        errors.AddRange(customerPreference.Validate());
      }
      return errors;
    }
  }
