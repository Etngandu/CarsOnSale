...
namespace ENB.Car.Sales.Entities.Collections
{
  ...
  /// </summary>
  public class CarModels : CollectionBase<CarModel>
  {
        /// <summary>
        ...
        public CarModels(IList<CarModel> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public CarModels(CollectionBase<CarModel> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var carModel in this)
      {
        errors.AddRange(carModel.Validate());
      }
      return errors;
    }
  }
